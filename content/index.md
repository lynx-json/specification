...
- it MAY have a `context` property. If present, its value MUST be an absolute URI representing either the realm or the content location of a document that must be displayed when the document is displayed.
